...
const data = () => {
  return (
    <div className={` min-[1200px]:p-[50px_72px] p-[20px_15px]  ${workSans.className}  text-[15px]`}>
    <div className='grid lg:grid-cols-2 grid-cols-1 rounded-2xl gap-6 p-[20px]  bg-white'>

      <div className='flex flex-col gap-6 '>
        <h1 className={`${urbanist.className} font-bold lg:text-[22px] text-[22px]`}>Product details</h1>
        ...
        <ul className='desc text-[#777777]'>
            ...
            <li>
                <h3 className='w-0'>General dimensions
</h3>
            ...
            <li>
                <h3 className='w-0'>Box dimensions
</h3>
      ...
      <div className='flex flex-col gap-6'>
        <h1 className={`${urbanist.className} font-bold lg:text-[22px] text-[20px]`}>Description</h1>
