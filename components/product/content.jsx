...
const content = () => {
  ...
  return (
    <div className={`${workSans.className} grid grid-cols-[1.15fr_.85fr] gap-5 bg-white min-[1200px]:p-[10px_72px] p-[20px_5px] `}>
...
/>
      ...
      <div className="flex flex-col text-[15px] gap-5">
        <span className="grid grid-cols-[3.5fr_.5fr] mt-[10px]">
          <h1 className={`${urbanist.className} text-[28px] font-bold`}>
            Giro LR
          </h1>
        ...
        <span className="flex gap-2 p-[20px] bg-[rgba(16,16,16,0.03)]">
          ...
          <span className="flex flex-col gap-2">
            <h1 className={`${urbanist.className} text-[18px] font-bold`}>
              Soft Edge collection
            </h1>
            <h2>
              Hurry and get discounts up to 20% <span>Read more</span>
            </h2>
          </span>
        </span>
        <p>
        ...
        <small className="text-[34px]">$449.00</small>
        <span className="flex gap-4 w-full">
          <span className="flex items-center w-[20%]">
            <h3 className="px-4 py-2 border-[1px] border-[rgba(0,0,0,0.1)] rounded-l-2xl">
              -
            </h3>
            <h3 className="border-[1px] border-[rgba(0,0,0,0.1)] border-x-0 px-4 py-2">
              1
            </h3>
            <h3 className="px-4 py-2 border-[1px] border-[rgba(0,0,0,0.1)] rounded-r-2xl">
              +
            </h3>
          </span>
          <button className="bg-[rgb(245,154,87)] w-[35%] rounded-[20px] text-white">
            Add to cart
          </button>
          <button className="bg-black text-white w-[35%] rounded-[20px]">
            Buy now
          </button>
        </span>
        <span className="flex gap-4 text-[#333] mt-6 font-medium">
        <h2><i class="ri-shuffle-line text-[16px] mr-2"></i>Add to compare</h2>
        <h2><i class="ri-heart-line text-[16px] mr-2"></i>Add to wishlist</h2>
        <h2><i class="ri-ruler-line text-[16px] mr-2"></i>Size Guide</h2></span>
        <ul>
            <li className="overflow-hidden text-[#242424]  relative" onClick={()=>{show === 1? setShow(0) : setShow(1)}}> <span className="flex justify-between items-center">
            ...
            <hr className="border-[#bbb] my-3" />
             <li className="overflow-hidden text-[#242424]   relative" onClick={()=>{show === 2? setShow(0) : setShow(2)}}> <span className="flex justify-between items-center">
