      ...
      <div className="flex flex-col gap-5">
        ...
        <span className="block bg-white rounded-2xl p-5">
            ...
            <span className="flex gap-3 mt-8"> 
                <input type="text" name="code" id="" placeholder='Coupon code' className="pl-[15px] border-[rgba(0,0,0,0.1)] border-[1px] py-2.5 px-6 text-[14px] rounded-4xl"/>
                <button className='bg-[#f59a57] text-white px-4 py-2.5 rounded-4xl text-[13px] font-medium'>Apply coupon</button>
            </span>
        </span>
      ...
      <div className="flex flex-col gap-5">
          <div className="bg-white p-5 rounded-2xl">
            ...
            <span className="border-b-[1px] border-[rgba(0,0,0,0.1)] flex justify-between p-[15px_0] mt-3">
              ...
              <small className="text-[#777777] text-[15px]">$12,123.00</small>
            </span>
            <span className="border-b-[1px] border-[rgba(0,0,0,0.1)] flex justify-between items-center text-[15px] p-[15px_0] ">
             ...
             <span className="grid gap-2 text-end">
              ...
              <small className="text-[#f59a57] text-[15px] font-medium">Change address</small>
             </span>
            </span>
            <span className=" flex justify-between p-[15px_0] ">
              <h2 className={`${urbanist.className} text-[#242424] font-semibold`}>Total</h2>
              <small className="text-[#f59a57] text-[19.5px] font-semibold">$12,123.00</small>
            </span>
            <button className="bg-[#f59a57] w-full min-h-[42px] my-3 rounded-4xl text-white">Proceed to checkout</button>
          </div>
