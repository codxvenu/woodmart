...
const head = () => {
  ...
  <div>
    <span class="font-medium hover:text-[#E9E9E9] cursor-pointer underline underline-offset-2">Continue shopping</span> "{cart.length!==0 ? cart[-1].name : ""}" has been added to your cart.
  </div>
</div>}
  ...
  <div>
     Sorry, your session has expired. <span class="font-medium hover:text-[#E9E9E9] cursor-pointer underline underline-offset-2" onClick={()=>{setProduct("shop");router.push("./product_category");}}>Return to shop</span>
  </div>
</div>
}
    </div>
